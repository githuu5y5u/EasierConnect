...
type RcData struct {
	...
	Svc            string `xml:"svc,attr" json:"svc"`
	Host           string `xml:"host,attr" json:"host"`
	Port           string `xml:"port,attr" json:"port"`
	EnableDisguise string `xml:"enable_disguise,attr" json:"enable_disguise"`
	Note           string `xml:"note,attr"  json:"note"`
	Attr           string `xml:"attr,attr" json:"attr"`
	AppPath        string `xml:"app_path,attr" json:"app_path"`
	RcGrpID        string `xml:"rc_grp_id,attr" json:"rc_grp_id"`
	RcLogo         string `xml:"rc_logo,attr" json:"rc_logo"`
	Authorization  string `xml:"authorization,attr" json:"authorization"`
	AuthSpID       string `xml:"auth_sp_id,attr" json:"auth_sp_id"`
	Selectid       string `xml:"selectid,attr" json:"selectid"`
}
...
type Resource struct {
	...
	RcGroups struct {
		Group []struct {
			...
			Name        string `xml:"name,attr"json:"name"`
			Type        string `xml:"type,attr" json:"type"`
			Logowidth   string `xml:"logowidth,attr" json:"logowidth"`
			Logoheight  string `xml:"logoheight,attr" json:"logoheight"`
			LoadBalance string `xml:"load_balance,attr" json:"load_balance"`
			ShowNote    string `xml:"show_note,attr" json:"show_note"`
		} `xml:"Group"`
	} `xml:"RcGroups"`
	SD struct {
		Global struct {
			Enable         string `xml:"enable,attr" json:"enable"`
			SDRedirectFile string `xml:"SDRedirectFile,attr" json:"SDRedirectFile"`
		} `xml:"Global"`
		Policy struct {
			ID string `xml:"id,attr" json:"id"`
		} `xml:"Policy"`
